...
class sectron(asynchat.async_chat):
	...
	def load(self,modname):
		self.modules["M_"+modname] = __import__("M_"+modname)
		self.modules["M_"+modname].modinit(self)
		return self.modules["M_"+modname]
	
	def unload(self,modname):
		self.modules["M_"+modname].moddeinit(self)
		del self.modules["M_"+modname]
